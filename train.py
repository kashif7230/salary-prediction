...
education = input("Enter Education Level (e.g., Bachelor's, Master's, PhD): ")
experience = int(input("Enter Years of Experience: "))
job_title = input("Enter Job Title (e.g., Software Engineer, Data Analyst, etc. ): ")
